...
- inserts/updates compatnies table and price_history hypertable
...
ith open(args.tickers_file) as f:
...
if __name__ == "__main__":
    ...
    w   tickers = [l.strip() for l in f if l.strip()]
